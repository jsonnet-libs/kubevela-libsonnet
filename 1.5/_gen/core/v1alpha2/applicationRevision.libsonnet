  ...
  spec: {
    ...
    application: {
      ...
      status: {
        ...
        '#policy':: d.obj(help='"PolicyStatus records the status of policy"'),
        policy: {
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
        ...
        workflow: {
          ...
          '#withMode':: d.fn(help='"WorkflowMode describes the mode of workflow"', args=[d.arg(name='mode', type=d.T.string)]),
