    ...
    application: {
      ...
      spec: {
        ...
        workflow: {
          ...
          mode: {
            '#withSteps':: d.fn(help='"WorkflowMode describes the mode of workflow"', args=[d.arg(name='steps', type=d.T.string)]),
            withSteps(steps): { spec+: { application+: { spec+: { workflow+: { mode+: { steps: steps } } } } } },
            '#withSubSteps':: d.fn(help='"WorkflowMode describes the mode of workflow"', args=[d.arg(name='subSteps', type=d.T.string)]),
          ...
          steps: {
            ...
            '#meta':: d.obj(help='"WorkflowStepMeta contains the meta data of a workflow step"'),
            meta: {
