{
  ...
  spec: {
    '#compression':: d.obj(help='"ResourceTrackerCompression represents the compressed components in ResourceTracker."'),
    compression: {
    ...
    managedResources: {
      ...
      '#withSkipGC':: d.fn(help='"SkipGC marks the resource to skip gc"', args=[d.arg(name='skipGC', type=d.T.boolean)]),
      withSkipGC(skipGC): { skipGC: skipGC },
